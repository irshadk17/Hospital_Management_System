...
public class AppoinmentDao {
	...
	public boolean addAppoinment(Appoinment ap) {
		boolean f=false;
		try {
			String sql="insert into appoinment(user_id, fulname, gender, age, appoint_date, email, phno, diseases, doctor_id, address, status) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public List<Appoinment> getAllApoinmentByLoginUser(int userId) {
	...
	public List<Appoinment> getAllApoinmentByDoctorLogin(int doctorId) {
		List<Appoinment> list=new ArrayList<Appoinment>();
		Appoinment ap=null;
		try {
	...
	public Appoinment getAllApoinmentById(int id) {
	...
	public List<Appoinment> getAllApoinment() {
		List<Appoinment> list=new ArrayList<Appoinment>();
		Appoinment ap=null;
		try {
